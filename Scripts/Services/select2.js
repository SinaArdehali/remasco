...
(function ($) {
    if (typeof $.fn.each2 == "undefined") {
        $.extend($.fn, {
            ...
            * use it carefully, as it overrides $ context of element on each iteration
            */
            each2: function (c) {
                ...
                while (
                    ...
                    && c.call(j[0], i, j) !== false //"this"=DOM, i=index, j=$ object
                );
                return this;
            }
        });
...
(function ($, undefined) {
     ...
     * @param options.dataType request data type: ajax, jsonp, other datatypes supported by $'s $.ajax function or the transport function if specified
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            // if $.mousewheel plugin is installed we can prevent out-of-bounds scrolling of results via mousewheel
            if ($.fn.mousewheel) {
        ...
        blur: function () {
            ...
            // synonymous to .is(':focus'), which is available in $ >= 1.6
        ...
        getPlaceholder: function () {
            ...
            return this.opts.element.attr("placeholder") ||
                this.opts.element.attr("data-placeholder") || // $ 1.4 compat
         ...
         * falls back to the $ calculated element width.
         */
        // abstract
...
//     * @param options.url url for the data
//     * @param options.data a function(searchTerm, pageNumber, context) that should return an object containing query string parameters for the above url.
//     * @param options.dataType request data type: ajax, jsonp, other datatatypes supported by $'s $.ajax function or the transport function if specified
//     * @param options.quietMillis (optional) milliseconds to wait before making the ajaxRequest, helps debounce the ajax function if invoked too often
//     * @param options.results a function(remoteData, pageNumber) that converts data returned form the remote request to the format expected by Select2.
//     *      The expected format is an object containing the following keys:
//     *      results array of objects that will be used as choices
...
//angular.module('ui', ['ui.filters', 'ui.directives', 'ui.config', 'hdApp.directives']);


angular.module('dataBallApp')
